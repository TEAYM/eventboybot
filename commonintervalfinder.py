# rmb to install these ext packages (either through PyCharm's project settings or by using pip from a terminal with
# 'pip' installed. TODO: use a dependency management tool to manage these package dependencies
...
#sample data
datetime_intervals = [
    Interval(dt(year=2018, month=6, day=1, hour=0), dt(year=2018, month=6, day=2, hour=10), 20001),
    Interval(dt(year=2018, month=7, day=3, hour=7), dt(year=2018, month=7, day=5, hour=10), 20001),
    Interval(dt(year=2018, month=6, day=1, hour=5), dt(year=2018, month=6, day=2, hour=10), 20002),
    Interval(dt(year=2018, month=6, day=3, hour=2), dt(year=2018, month=6, day=3, hour=18), 20003),
    Interval(dt(year=2018, month=6, day=3, hour=2), dt(year=2018, month=6, day=3, hour=18), 20005),
    Interval(dt(year=2018, month=6, day=3, hour=2), dt(year=2018, month=6, day=3, hour=10), 20006),
    Interval(dt(year=2018, month=7, day=3, hour=7), dt(year=2018, month=7, day=5, hour=18), 20004)
]
